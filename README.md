...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytestify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14889&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytestify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytestify` can be installed with:

```
conda install pytestify
```

It is possible to list all of the versions of `pytestify` available on your platform with:
